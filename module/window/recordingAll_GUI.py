...
class ScreenRecorder:
    def __init__(self, root):
        ...
        self.start_button.config(width=30, height=2)
        
        self.stop_button = tk.Button(root, text='Stop Recording', command=self.stop_recording)
        self.stop_button.pack()
        
        self.stop_button.config(width=30, height=2)
        ...
        contact_label1.pack(pady=5)
        contact_label2.pack()
        contact_label2.bind("<Button-1>", lambda e: webbrowser.open("https://taskautomation.tistory.com"))
